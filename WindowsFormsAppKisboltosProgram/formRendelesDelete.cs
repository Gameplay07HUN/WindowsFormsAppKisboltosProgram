...
{
    public partial class formRendelesDelete : Form
    {
        Database db = new Database("localhost", "root", "", "kisbolt2");
        public formRendelesDelete()
        {
            InitializeComponent();
        }

        private void formRendelesDelete_Load(object sender, EventArgs e)
        {
        ...
        private void buttonModosit_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "DELETE FROM `rendeles` WHERE `cikkszam` = @cikkszam";

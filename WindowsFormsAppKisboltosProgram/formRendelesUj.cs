...
{
    public partial class formRendelesUj : Form
    {
        Database db = new Database("localhost", "root", "", "kisbolt2");
        public formRendelesUj()
        {
            InitializeComponent();
        }

        private void formRendelesUj_Load(object sender, EventArgs e)
        {
        ...
        private void buttonUj_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "INSERT INTO `rendeles` (`cikkszam`,`vevokod`,`datum`,`mennyiseg`,`beszerzesiar`) VALUES (@cikkszam, @vevokod, @datum, @mennyiseg, @beszerzesiar);";

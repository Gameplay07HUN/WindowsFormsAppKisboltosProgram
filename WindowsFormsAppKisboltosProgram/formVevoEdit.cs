...
{
    public partial class formVevoEdit : Form
    {
        ...
        private void formVevoEdit_Load(object sender, EventArgs e)
        {
        ...
        private void buttonUj_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "UPDATE `vevo` SET `vevokod` = @vevokod, `vevonev` = @vevonev WHERE `vevo`.`vevokod` = @vevokod;";
